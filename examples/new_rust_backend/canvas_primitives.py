...
Run interactively with the Rust canvas runtime:
...
Compare against canvas offscreen:
    uv run python examples/new_rust_backend/canvas_primitives.py --headless --frames 1
"""
