"""ECS performance scenario: spatial relations, events, and event for_each.
...
SIGNAL_COUNT = 1_200
BEACON_COUNT = 10
OUTPUT = Path("examples/output/09_performance/ecs_scenarios/spatial_events_for_each_stress.png")
