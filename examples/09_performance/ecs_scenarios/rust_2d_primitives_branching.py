"""ECS performance scenario: Rust systems, branching, events, and 2D primitives.
...
OUTPUT = Path("examples/output/09_performance/ecs_scenarios/rust_2d_primitives_branching.png")
