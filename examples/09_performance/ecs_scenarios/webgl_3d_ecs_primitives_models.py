"""ECS performance scenario: Rust ECS 3D simulation with WEBGL drawing.
...
TARGET_FPS = 60
BODY_COUNT = 1_200
OUTPUT = Path("examples/output/09_performance/ecs_scenarios/webgl_3d_ecs_primitives_models.png")
