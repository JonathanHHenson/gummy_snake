"""Temporary ECS perf sketch: dynamic tag/component churn with visual effects.
...
OUTPUT = Path("examples/output/11_temporary_perf_tests/structural_churn_tags_components.png")
