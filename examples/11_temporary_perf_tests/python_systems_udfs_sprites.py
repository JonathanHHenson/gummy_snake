"""Temporary ECS perf sketch: Python systems, Python UDFs, and 2D sprites.
...
TARGET_FPS = 60
SPRITE_COUNT = 900
OUTPUT = Path("examples/output/11_temporary_perf_tests/python_systems_udfs_sprites.png")
