...
- `new_rust_backend/` contains focused examples for the experimental `backend="canvas"` Rust renderer, including primitive rendering, transforms/pixel-density mapping, pixel-buffer updates, and PNG export.
