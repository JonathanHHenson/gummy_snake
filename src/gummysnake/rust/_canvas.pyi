...
def synth_set_worker_count(value: int | str) -> int: ...
...
class CanvasMediaFrameSink:
    def __init__(self, width: int, height: int) -> None: ...
    @property
    def image(self) -> CanvasImage: ...
    def update(
        self,
        pixels: Buffer,
        width: int,
...
class CanvasVideo:
    ...
    def read(self) -> CanvasImage | None: ...
    def current_frame(self) -> CanvasImage | None: ...
    def close(self) -> None: ...
    def diagnostics(self) -> dict[str, object]: ...

class GpuStorageBuffer:
    @staticmethod
    def from_bytes(payload: bytes, size: int, dtype: str) -> GpuStorageBuffer: ...
    @property
    def size(self) -> int: ...
    @property
    def dtype(self) -> str: ...
...
class GpuComputeShader:
    @staticmethod
    def from_wgsl(
        source: str, entry_point: str = "main", label: str | None = None
    ) -> GpuComputeShader: ...
    def dispatch(self, buffers: list[GpuStorageBuffer], x: int, y: int = 1, z: int = 1) -> None: ...
