...
def synth_play_compiled_program(program: CanvasSynthProgram) -> CanvasAudioPlayback: ...
def synth_play_serialized_plan(payload: bytes, sample_rate: int) -> CanvasAudioPlayback: ...
