...
from gummysnake.ecs.logical_plan.specifications import EventWriterProxy
...
def action_write_targets(action: Action) -> builtins.set[tuple[object, type[Any], str]]:
    ...
    from gummysnake.ecs.logical_plan.inspection.analysis import action_write_targets as analyze
...
def action_query_refs(action: Action) -> builtins.set[QueryProxy]:
    ...
    from gummysnake.ecs.logical_plan.inspection.analysis import action_query_refs as analyze
