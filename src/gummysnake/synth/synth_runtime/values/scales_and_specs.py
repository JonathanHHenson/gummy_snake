...
from gummysnake.synth.synth_runtime.values.lazy_values import MusicExpression, Ring, ensure_expr
...
if TYPE_CHECKING:
    ...
    from gummysnake.synth.synth_runtime.composition.logical_nodes import NodeHandle
...
class SynthSignal:
    ...
    def output(self) -> tuple[NodeHandle, ...]:
        ...
        from gummysnake.synth.synth_runtime.composition.context_managers import synth_output
