"""Input event compatibility module.
...
def _load_input_event_model() -> None:
    package = f"{__package__}.input_event_model"
...
_load_input_event_model()
del _load_input_event_model
