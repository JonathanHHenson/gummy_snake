...
from p5_py.plugins.base import (
    EVENT_HOOKS,
    LIFECYCLE_HOOKS,
    PluginApi,
    PluginHookName,
...
if TYPE_CHECKING:
    ...
    from p5_py.events.input_state import KeyboardEvent, MouseEvent, TouchEvent
...
class PluginRegistry:
    ...
    def _assert_public_name_available(self, name: str) -> None:
        for module_name in ("p5_py", "p5_py.api.global_mode"):
    ...
    def _install_global_api(self, name: str) -> None:
        ...
        for module_name in ("p5_py.api.global_mode", "p5_py"):
            module = sys.modules.get(module_name)
