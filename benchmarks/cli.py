...
from .governance import ExecutionClass, GovernanceError, reject_policy_overrides
...
def _dispatch_smoke(catalog: Catalog) -> list[dict[str, object]]:
    ...
    This command is intentionally non-recording: it performs no baseline lookup,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        reject_policy_overrides(arguments)
