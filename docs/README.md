...
The `docs/` tree is split into two audiences.

## User docs

These guides are for sketch authors and new users:
...
These guides are for maintainers, contributors, and architecture/release work:
